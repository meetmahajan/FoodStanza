...
<body class="in_background1">
    ...
    <div align="center" class="in_login">
        ...
        <form action="SignInCode.php" method="post" name="SignIn">
            <table>
                <tr>
                    <td align="center">
                ...
                <tr>
                    <td align="center">
                        <input style="margin:10px;font-size:large;font-family:Arial;color:black;min-width:254px;background-color:gold;border-color:red;" class="btn btn-danger navbar-btn" type="Submit" name="SignIn" value="Sign in" />
                    </td>
                </tr>
