...
<html>
	...
	<nav style="background-color:black;border:0px;padding:0px;" class="navbar navbar-inverse navbar-fixed-top">
		...
		while($row = mysql_fetch_array($display))
		{
			...
			echo "<div class='col-xs-12' onmouseover='enter(this)' onmouseout='leave(this)' style='font-size:27px;background-color:#eaeaea;width:500px;margin-top:50px;margin-right:40px;border-radius:10px;border:solid;border-width:1px;;border-color:red;padding:0px'>";		
			echo $row['StallName'];
			echo "</div>";
			echo "</a>";
		}
