...
<html>
	...
	$display = mysql_query("select * from streetfood where Code='GUAHM05UCB'");
	...
	<nav style="background-color:black;border:0px;padding:0px;" class="navbar navbar-inverse navbar-fixed-top">
            <div class="col-xs-12">
                    <a style="font-family:'Times New Roman';font-size:40px;color:white;margin:5px" class="navbar-brand" href="home.php">FoodStanza</a>
                    <ul class="nav navbar-nav navbar-right">
                        <li style="font-size:18px;margin-top:5px"><a href="index.php"><span class="glyphicon glyphicon-user"></span> Sign In</a></li>
                        <li style="font-size:18px;margin-top:5px"><a href="SignUp.php"><span class="glyphicon glyphicon-log-in"></span> Sign Up</a></li>
                    </ul>
                </div>
        </nav>
